...
### Fixed
- Adjustments to the Helmut extension to make it loadable in conjunction with Adobe Media Encoder 22.3.x (Compatible with Adobe Media Encoder CC 21 & 22) (license:4.1.0.17; hc:4.2.0.6)
...
- Webupload profile is now assignable to a group (hw:4.1.3.14)
### Changed
...
- Set default value "Use cron" of watchfolder dialog to false (hw:4.1.3.12)
### Changed
...
- Cosmo Webimport filechooser dialog has now pagination and does not show folder sizes anymore (hc:4.1.0.1, license:4.1.0.1, hw:4.1.0.1)
- Colon in Metadata fields is now a supported character for select, multiselect and autocomplete fields (hp:4.1.0.1, hw:4.1.0.1)
...
- Hide enabled switch in watchfolder edit dialog when trigger point is a cronjob (hw:4.1.0.1)
...
- Ensure job.assetId field beeing filled with information for webexport and panel import in order to be able to use the new asset metadata manipulation nodes (hw:4.1.0.1; hp:4.1.0.1)
...
- Changed the behaviour of the select sequences multiselect field in export tab of the panel (hp:4.0.6.8)
